const CACHE = 'kv-1.4.2';
const APP_SHELL = [
  './',
  'index.html',
  'review-core.js?v=1.4.2',
  'focus-core.js?v=1.4.2',
  'audio-cache.js?v=1.4.2',
  'ui-motion.js?v=1.4.2',
  'manifest.json',
  'hb/',
  'hb/index.html',
  'uf/',
  ...
  e.waitUntil(
    caches.open(CACHE)
      .then(cache => Promise.all([
        ...
        cache.match('review-core.js?v=1.4.2'),
        cache.match('focus-core.js?v=1.4.2'),
        cache.match('audio-cache.js?v=1.4.2'),
        cache.match('ui-motion.js?v=1.4.2')
      ]))
