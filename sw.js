const CACHE = 'kv-20260718-105228';
const APP_SHELL = [
  './',
  'index.html',
  'review-core.js?v=20260718-105228',
  'audio-cache.js?v=20260718-105228',
  'ui-motion.js?v=20260718-105228',
  'manifest.json',
  'hb/',
  'hb/index.html',
  'uf/',
  ...
  e.waitUntil(
    caches.open(CACHE)
      .then(cache => Promise.all([
        ...
        cache.match('review-core.js?v=20260718-105228'),
        cache.match('audio-cache.js?v=20260718-105228'),
        cache.match('ui-motion.js?v=20260718-105228')
      ]))
