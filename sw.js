const CACHE = 'kv-1.0.1';
const APP_SHELL = [
  './',
  'index.html',
  'review-core.js?v=1.0.1',
  'audio-cache.js?v=1.0.1',
  'ui-motion.js?v=1.0.1',
  'manifest.json',
  'hb/',
  'hb/index.html',
  'uf/',
  ...
  e.waitUntil(
    caches.open(CACHE)
      .then(cache => Promise.all([
        ...
        cache.match('review-core.js?v=1.0.1'),
        cache.match('audio-cache.js?v=1.0.1'),
        cache.match('ui-motion.js?v=1.0.1')
      ]))
