const CACHE = 'kv-1.5.17';
const APP_SHELL = [
  './',
  'index.html',
  'review-core.js?v=1.5.17',
  'focus-core.js?v=1.5.17',
  'audio-cache.js?v=1.5.17',
  'ui-motion.js?v=1.5.17',
  'manifest.json',
  'hb/',
  'hb/index.html',
  'uf/',
  ...
  e.waitUntil(
    caches.open(CACHE)
      .then(cache => Promise.all([
        ...
        cache.match('review-core.js?v=1.5.17'),
        cache.match('focus-core.js?v=1.5.17'),
        cache.match('audio-cache.js?v=1.5.17'),
        cache.match('ui-motion.js?v=1.5.17')
      ]))
