const CACHE = 'kv-1.4.3';
const APP_SHELL = [
  './',
  'index.html',
  'review-core.js?v=1.4.3',
  'focus-core.js?v=1.4.3',
  'audio-cache.js?v=1.4.3',
  'ui-motion.js?v=1.4.3',
  'manifest.json',
  'hb/',
  'hb/index.html',
  'uf/',
  ...
  e.waitUntil(
    caches.open(CACHE)
      .then(cache => Promise.all([
        ...
        cache.match('review-core.js?v=1.4.3'),
        cache.match('focus-core.js?v=1.4.3'),
        cache.match('audio-cache.js?v=1.4.3'),
        cache.match('ui-motion.js?v=1.4.3')
      ]))
