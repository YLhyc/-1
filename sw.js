const CACHE = 'kv-1.0.4';
const APP_SHELL = [
  './',
  'index.html',
  'review-core.js?v=1.0.4',
  'audio-cache.js?v=1.0.4',
  'ui-motion.js?v=1.0.4',
  'manifest.json',
  'hb/',
  'hb/index.html',
  'uf/',
  ...
  e.waitUntil(
    caches.open(CACHE)
      .then(cache => Promise.all([
        ...
        cache.match('review-core.js?v=1.0.4'),
        cache.match('audio-cache.js?v=1.0.4'),
        cache.match('ui-motion.js?v=1.0.4')
      ]))
